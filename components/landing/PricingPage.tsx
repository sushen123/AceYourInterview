...
export const tiers: PricingTier[] = [
  {
    ...
    features: [
      `Limited AI Mock Interviews (5 per month)`,
      `Access to Question Banks (Limited)`,
      `Peer-to-Peer Interviews (Limited to 2 per month)`,
      `Resume Maker Templates`,
      `Job Auto-Apply (Limited to 3 applications per month)`,
    ],
    featured: false,
    highlighted: false,
    soldOut: false,
  ...
  },
  {
    ...
    href: '/subscribe',
    price: { '1': '$13', '2': '$120' },
    discountPrice: { '1': '9.99', '2': '$69' },
    description: `Upgrade to Pro – Unlock Advanced Features and Premium Support!`,
    features: [
      `Unlimited AI Mock Interviews`,
      `Advanced Resume Screening with personalized feedback`,
      `Full Access to Question Banks`,
      `Unlimited Peer-to-Peer Interviews`,
      `Professional Resume Maker Templates`,
      `Enhanced Job Auto-Apply (Unlimited applications)`,
      `Personalized Interview Coaching and Tips`,
      `Priority Support`,
    ],
    featured: true,
    highlighted: true,
...
export default function PricingPage() {
  ...
  const bannerText = 'Exclusive 30% Off – Get Ahead in Your Career Without the Extra Cost!';
