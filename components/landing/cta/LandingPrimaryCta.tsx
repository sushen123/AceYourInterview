...
export const LandingPrimaryVideoCtaSection = ({
  ...
  return (
    ...
    >
      <div className={`fixed flex justify-between items-center top-0 py-3  z-50 w-full px-6 lg:px-20 ${isScrolled ? "bg-white/40 backdrop-blur-lg border border-white/20" : ""}  rounded-lg`}>
      <div className='flex justify-center items-center'>
      <Image src={'/logo.png'} width={40} height={40} alt='/logo' /> 
      <h1 className='text-xl ml-2'>AceYourInterview</h1>
      </div>
